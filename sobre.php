	...
	<div class="container_sobre">
		<div class="titulo">
			...
			<p>Nosso centro de distribuição fica em  <a href="https://maps.google.com.br/?q=Jacarezinho"> <em>Jacarezinho, no Paraná</em> </a>. De lá, saem 48 aviões que distribuem nossos produtos às casas do mundo todo. Nosso centro de distribuição: </p>
		...
		<div class="diferenciais">
			<h2 > Diferenciais</h2>
				<ul>
					...
					<li>Maior comércio eletronico de moda do muundo</li>
					<li>Atendimento via e-mail, chat, twitter, facebook,carta,fax e telegrama</li>
					<li>Presente em 12 países</li>
					<li>Mais de um milhão de funcionários no mundo</li>
